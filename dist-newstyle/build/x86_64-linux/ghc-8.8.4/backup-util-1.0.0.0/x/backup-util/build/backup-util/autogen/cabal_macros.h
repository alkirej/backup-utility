...
/* package backup-util-1.0.0.0 */
#ifndef VERSION_backup_util
#define VERSION_backup_util "1.0.0.0"
#endif /* VERSION_backup_util */
#ifndef MIN_VERSION_backup_util
#define MIN_VERSION_backup_util(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
  (major1) == 1 && (major2) == 0 && (minor) <= 0)
#endif /* MIN_VERSION_backup_util */
...
#define CURRENT_COMPONENT_ID "backup-util-1.0.0.0-inplace-backup-util"
